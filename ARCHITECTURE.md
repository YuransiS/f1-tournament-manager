...
- `src/components/RacesView.jsx`: Complete list of Grand Prix events (including Race 16 Monza), sprint races, penalty notes, track layouts, and race result breakdowns.
